import type { AIAnalysis, MergedAnalysis } from "./schema";

export function mergeResults(results: AIAnalysis[]): MergedAnalysis {
  const merged: MergedAnalysis = {
    ...
    categories: [] as MergedAnalysis["categories"],

    sentimentComments: [] as MergedAnalysis["sentimentComments"],
  ...
  for (const result of results) {
    ...
    merged.sentimentComments.push(
      ...result.sentimentComments
    );
